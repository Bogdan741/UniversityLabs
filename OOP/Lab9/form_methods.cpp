...
//}
//--------------------------------------------------------------------------------
System::Void Lab8::MyForm::button4_Click_1(System::Object^ sender, System::EventArgs^ e)
{
	textBox2->Text = Convert::ToString(d->TimeLeft());
}
System::Void Lab8::MyForm::button9_Click_1(System::Object^ sender, System::EventArgs^ e)
{
	textBox9->Text = Convert::ToString(d->TimeLeft());
}
System::Void Lab8::MyForm::button15_Click_1(System::Object^ sender, System::EventArgs^ e)
{
	textBox14->Text = Convert::ToString(d->TimeLeft());
}
//--------------------------------------------------------------------------------