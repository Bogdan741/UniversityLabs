...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(486, 180);
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(406, 143);
			this->button4->Name = L"button4";
			this->button4->Size = System::Drawing::Size(180, 23);
			this->button4->TabIndex = 22;
			this->button4->Text = L"Скільки часу залишилось";
			...
			// textBox9
			// 
			this->textBox9->Location = System::Drawing::Point(486, 180);
			...
			// button9
			// 
			this->button9->Location = System::Drawing::Point(406, 143);
			this->button9->Name = L"button9";
			this->button9->Size = System::Drawing::Size(180, 23);
			this->button9->TabIndex = 42;
			this->button9->Text = L"Скільки часу залишилось";
			...
			// textBox14
			// 
			this->textBox14->Location = System::Drawing::Point(484, 191);
			...
			// button15
			// 
			this->button15->Location = System::Drawing::Point(404, 154);
			this->button15->Name = L"button15";
			this->button15->Size = System::Drawing::Size(180, 23);
			this->button15->TabIndex = 68;
			this->button15->Text = L"Скільки часу залишилось";
...
private: System::Void MyForm_Load(System::Object^ sender, System::EventArgs^ e) {
	NullDeposit** a = new NullDeposit* [3];
	TermDeposit t(1000.0, 12, 0.1);
	CumulitiveDeposit1 c(1000.0, 12, 0.1);
	VIPDeposit v(1000.0, 12, 0.1, 0.05, 10000.0);
	a[0] = &t;
	a[1] = &c;
	a[2] = &v;
	auto str = a[0]->print() + a[1]->print() + a[2]->print();
	String^ const st = gcnew String(str.c_str());
	MessageBox::Show(st);
}
};
}
